...
public class Register extends JFrame {
	...
	public Register(Controller c,JFrame frameChiamante) 
	{
		...
		JLabel RegistratoreLabel = new JLabel("<html><div style='text-align: center;'> Register View </div></html>");
		RegistratoreLabel.setForeground(new Color(0, 0, 0));
		RegistratoreLabel.setBounds(85, 11, 108, 45);
		PanelViewInformation.add(RegistratoreLabel);
		RegistratoreLabel.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 15));
		...
		PanelRegistrazione.setBackground(new Color(105, 105, 105));
		...
		PanelGraficoregistrazione.setBackground(new Color(204, 204, 255));
